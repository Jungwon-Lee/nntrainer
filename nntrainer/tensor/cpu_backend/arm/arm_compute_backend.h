 ...
 *       declaration below is compiled out. Uses the __fp16 builtin (always
 *       available on ARM); the definition lives in libnntrainer (built with
 *       ENABLE_FP16=1) and resolves at link time. Under ENABLE_FP16 the _FP16
 ...
 *       overload should _FP16 ever resolve to _Float16.
 */
