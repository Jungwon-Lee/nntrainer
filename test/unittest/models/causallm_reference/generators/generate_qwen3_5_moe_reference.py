...
"""Generate non-degenerate Hugging Face fixtures for Qwen3.5/3.6 MoE."""
...
DEFAULT_OUT = THIS_DIR.parent / "qwen3_5_moe_tiny"
sys.path.insert(0, str(CONVERTER_DIR))

from weight_converter import save_qwen3_5_moe_for_nntrainer  # noqa: E402
...
def build_model(seed):
    ...
    config = Qwen3_5MoeTextConfig(**TINY_CONFIG)
...
def main():
    ...
    values = {
        ...
        "meta.json": {
            ...
            "reference": "Hugging Face Qwen3_5MoeForCausalLM",
        },
    }
